...
class TerzoConto_Installer {
    ...
    private static function seed_defaults(): void {
        ...
        $model_d = [
            ['A', 1, 'U', __('Materie prime, sussidiarie, di consumo e di merci', 'terzoconto-rendiconto-ets')],
            ['A', 2, 'U', __('Servizi', 'terzoconto-rendiconto-ets')],
            ['A', 3, 'U', __('Godimento beni di terzi', 'terzoconto-rendiconto-ets')],
            ['A', 4, 'U', __('Personale', 'terzoconto-rendiconto-ets')],
            ['A', 5, 'U', __('Uscite diverse di gestione', 'terzoconto-rendiconto-ets')],
            ['B', 1, 'U', __('Materie prime, sussidiarie, di consumo e di merci', 'terzoconto-rendiconto-ets')],
            ['B', 2, 'U', __('Servizi', 'terzoconto-rendiconto-ets')],
            ['B', 3, 'U', __('Godimento beni di terzi', 'terzoconto-rendiconto-ets')],
            ['B', 4, 'U', __('Personale', 'terzoconto-rendiconto-ets')],
            ['B', 5, 'U', __('Uscite diverse di gestione', 'terzoconto-rendiconto-ets')],
            ['C', 1, 'U', __('Uscite per raccolte fondi abituali', 'terzoconto-rendiconto-ets')],
            ['C', 2, 'U', __('Uscite per raccolte fondi occasionali', 'terzoconto-rendiconto-ets')],
            ['C', 3, 'U', __('Altre uscite', 'terzoconto-rendiconto-ets')],
            ['D', 1, 'U', __('Su rapporti bancari', 'terzoconto-rendiconto-ets')],
            ['D', 2, 'U', __('Su investimenti finanziari', 'terzoconto-rendiconto-ets')],
            ['D', 3, 'U', __('Su patrimonio edilizio', 'terzoconto-rendiconto-ets')],
            ['D', 4, 'U', __('Su altri beni patrimoniali', 'terzoconto-rendiconto-ets')],
            ['D', 5, 'U', __('Altre uscite', 'terzoconto-rendiconto-ets')],
            ['E', 1, 'U', __('Materie prime, sussidiarie, di consumo e di merci', 'terzoconto-rendiconto-ets')],
            ['E', 2, 'U', __('Servizi', 'terzoconto-rendiconto-ets')],
            ['E', 3, 'U', __('Godimento beni di terzi', 'terzoconto-rendiconto-ets')],
            ['E', 4, 'U', __('Personale', 'terzoconto-rendiconto-ets')],
            ['E', 5, 'U', __('Altre uscite', 'terzoconto-rendiconto-ets')],
            ['A', 1, 'E', __('Entrate da quote associative e apporti dei fondatori', 'terzoconto-rendiconto-ets')],
            ['A', 2, 'E', __('Entrate dagli associati per attività mutuali', 'terzoconto-rendiconto-ets')],
            ['A', 3, 'E', __('Entrate per prestazioni e cessioni ad associati e fondatori', 'terzoconto-rendiconto-ets')],
            ['A', 4, 'E', __('Erogazioni liberali', 'terzoconto-rendiconto-ets')],
            ['A', 5, 'E', __('Entrate del 5 per mille', 'terzoconto-rendiconto-ets')],
            ['A', 6, 'E', __('Contributi da soggetti privati', 'terzoconto-rendiconto-ets')],
            ['A', 7, 'E', __('Entrate per prestazioni e cessioni a terzi', 'terzoconto-rendiconto-ets')],
            ['A', 8, 'E', __('Contributi da enti pubblici', 'terzoconto-rendiconto-ets')],
            ['A', 9, 'E', __('Entrate da contratti con enti pubblici', 'terzoconto-rendiconto-ets')],
            ['A', 10, 'E', __('Altre entrate', 'terzoconto-rendiconto-ets')],
            ['B', 1, 'E', __('Entrate per prestazioni e cessioni ad associati e fondatori', 'terzoconto-rendiconto-ets')],
            ['B', 2, 'E', __('Contributi da soggetti privati', 'terzoconto-rendiconto-ets')],
            ['B', 3, 'E', __('Entrate per prestazioni e cessioni a terzi', 'terzoconto-rendiconto-ets')],
            ['B', 4, 'E', __('Contributi da enti pubblici', 'terzoconto-rendiconto-ets')],
            ['B', 5, 'E', __('Entrate da contratti con enti pubblici', 'terzoconto-rendiconto-ets')],
            ['B', 6, 'E', __('Altre entrate', 'terzoconto-rendiconto-ets')],
            ['C', 1, 'E', __('Entrate da raccolte fondi abituali', 'terzoconto-rendiconto-ets')],
            ['C', 2, 'E', __('Entrate da raccolte fondi occasionali', 'terzoconto-rendiconto-ets')],
            ['C', 3, 'E', __('Altre entrate', 'terzoconto-rendiconto-ets')],
            ['D', 1, 'E', __('Da rapporti bancari', 'terzoconto-rendiconto-ets')],
            ['D', 2, 'E', __('Da altri investimenti finanziari', 'terzoconto-rendiconto-ets')],
            ['D', 3, 'E', __('Da patrimonio edilizio', 'terzoconto-rendiconto-ets')],
            ['D', 4, 'E', __('Da altri beni patrimoniali', 'terzoconto-rendiconto-ets')],
            ['D', 5, 'E', __('Altre entrate', 'terzoconto-rendiconto-ets')],
            ['E', 1, 'E', __('Entrate da distacco del personale', 'terzoconto-rendiconto-ets')],
            ['E', 2, 'E', __('Altre entrate di supporto generale', 'terzoconto-rendiconto-ets')],
        ];
    ...
    public static function register_attachment_taxonomy(): void {
        register_taxonomy('terzoconto_allegato_movimento', 'attachment', [
            'labels' => [
                'name' => __('Allegati TerzoConto', 'terzoconto-rendiconto-ets'),
                'singular_name' => __('Allegato Movimento', 'terzoconto-rendiconto-ets'),
            ],
            'public' => false,
            'show_ui' => false,
            'rewrite' => false,
